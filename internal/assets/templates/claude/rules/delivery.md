...
3. **`code-review` and `security-review`** subagents on the diff, and fix what they
   find. The PR should arrive already reviewed: a PR is for the human, and spending
   their attention on findings a subagent would have caught is pure waste.
