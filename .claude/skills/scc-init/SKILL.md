...
You fill an empty knowledge base from a repository that already exists. `$ARGUMENTS`
is the scope, if one was given; the table below is what to do when it was not.
